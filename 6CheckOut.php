<?php
    ...
    $cart_products_statement->execute();
    $cart_products = $cart_products_statement->fetchAll();
    $cart_products_statement->closeCursor();

    // Get Products Information
    $products = array();
    foreach($cart_products as $cart_item) {
        $products_query = "SELECT * FROM product WHERE id = :prodid";
        $products_stmt = $db->prepare($products_query);
        $products_stmt->bindValue(':prodid', $cart_item['ProductID']);
        $products_stmt->execute();
        $products[$cart_item['ProductID']] = $products_stmt->fetch();
    ...
    $pay_options_stmt->bindValue(':userid', $username);
...
<hmtl>
    <head>
        ...
        <link rel="checkout" href="StyleCheckOut.css">
    </head>
    <body>
        <div id="checkout-cont">
            ...
            <div id="checkout-data">
                ...
                <span id="checkout-data-mid">
                </span>
                <span id="checkout-cart-cont">
                    <div id="cart-items">
                    <?php foreach($products as $product) : ?>
                        <div class="cart-item-cont">
                            <div class="cart-item-img">
                                <?php $cart_img = file_get_contents($product['Image']); ?>
                            ...
                            <div class="cart-item-info">
                                ...
                                <p class="cart-item-cost">
                                    <?php $total_cost += $product['Cost'] * $product['Quantity']; ?>
                                    <?php echo $product['Cost'] * $product['Quantity']; ?>
                                </p>
                            </div>
                        </div>
                    <?php endforeach; ?>
